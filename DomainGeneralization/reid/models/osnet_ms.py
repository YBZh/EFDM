...
def osnet_x1_0_ms2_a0d1(num_classes=1000, pretrained=True, loss='softmax', **kwargs):
    # standard size (width x1.0)
    model = OSNet(
        num_classes,
        blocks=[OSBlock, OSBlock, OSBlock],
...
def osnet_x1_0_ms234_a0d1(num_classes=1000, pretrained=True, loss='softmax', **kwargs):
    ...
    model = OSNet(
        ...
        channels=[64, 256, 384, 512],
        loss=loss,
        mixstyle_layers=['conv2', 'conv3', 'conv4'],
        mixstyle_alpha=0.1,
        **kwargs
    )
    if pretrained:
...
def osnet_x1_0_ms2345_a0d1(num_classes=1000, pretrained=True, loss='softmax', **kwargs):
    # standard size (width x1.0)
    model = OSNet(
        num_classes,
        blocks=[OSBlock, OSBlock, OSBlock],
        ...
        channels=[64, 256, 384, 512],
        loss=loss,
        mixstyle_layers=['conv2', 'conv3', 'conv4', 'conv5'],
        mixstyle_alpha=0.1,
        **kwargs
    )
    if pretrained:
...
def osnet_x1_0_ms34_a0d1(num_classes=1000, pretrained=True, loss='softmax', **kwargs):
    # standard size (width x1.0)
    model = OSNet(
        num_classes,
        blocks=[OSBlock, OSBlock, OSBlock],
