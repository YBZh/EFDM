...
def resnet50_fc512_efdmix12_a0d2(num_classes, loss='softmax', pretrained=True, **kwargs):
    model = ResNet(
        num_classes=num_classes,
        loss=loss,
        block=Bottleneck,
...
def resnet50_fc512_efdmix12_a0d3(num_classes, loss='softmax', pretrained=True, **kwargs):
    model = ResNet(
        num_classes=num_classes,
        loss=loss,
        block=Bottleneck,
...
# more variants in which efdmix is applied to different layers
def resnet50_fc512_efdmix1_a0d1(num_classes, loss='softmax', pretrained=True, **kwargs):
    model = ResNet(
        num_classes=num_classes,
        loss=loss,
        block=Bottleneck,
...
def resnet50_fc512_efdmix123_a0d1(num_classes, loss='softmax', pretrained=True, **kwargs):
    model = ResNet(
        ...
        fc_dims=[512],
        dropout_p=None,
        efdmix_layers=['layer1', 'layer2', 'layer3'],
        efdmix_alpha=0.1,
        **kwargs
    )
    if pretrained:
...
def resnet50_fc512_efdmix1234_a0d1(num_classes, loss='softmax', pretrained=True, **kwargs):
    model = ResNet(
        num_classes=num_classes,
        loss=loss,
        block=Bottleneck,
        ...
        fc_dims=[512],
        dropout_p=None,
        efdmix_layers=['layer1', 'layer2', 'layer3', 'layer4'],
        efdmix_alpha=0.1,
        **kwargs
    )
    if pretrained:
...
def resnet50_fc512_efdmix23_a0d1(num_classes, loss='softmax', pretrained=True, **kwargs):
    model = ResNet(
        num_classes=num_classes,
        loss=loss,
        block=Bottleneck,
...
def resnet50_fc512_efdmix14_a0d1(num_classes, loss='softmax', pretrained=True, **kwargs):
    model = ResNet(
        num_classes=num_classes,
        loss=loss,
        block=Bottleneck,
